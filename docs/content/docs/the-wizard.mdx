...
Open OpenCode in your project and run `/repo-initialize`. For brownfield projects
this generates `ARCHITECTURE.md` and `DESIGN.md` from your actual codebase,
archives project history, then activates the full agent team. For greenfield
projects it skips documentation generation and leaves placeholder files you can
populate later with [`/make-architecture`](/docs/commands) and
[`/make-design`](/docs/commands).
